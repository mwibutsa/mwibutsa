...
const EMPLOYMENTS = [
  {
    ...
    description: [
      "Contributed to the creation of an NFT marketplace utilizing Next.js, React, and Tailwind CSS, and integrated Alchemy NFT APIs for seamless user transactions.",
      "Spearheaded the integration of Solidity contracts and web3 technologies to ensure secure and transparent on-chain transactions within the marketplace.",
      "Developed scalable Node.js backend APIs, utilized Prisma ORM for efficient PostgreSQL database operations, and ensured robust platform performance through continuous collaboration and skill upgrades.",
    ],
    stacks: [
      "Javascript",
      "React",
